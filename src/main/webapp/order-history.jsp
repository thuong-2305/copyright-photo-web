...
<section class="history container">
    ...
    <c:if test="${empty orders}">
        <div class="no-history text-center py-5">
            <h4>Không có lịch sử mua hàng</h4>
            <p class="text-muted">Bạn chưa thực hiện đơn hàng nào. Hãy khám phá các sản phẩm tuyệt vời của chúng
                tôi!</p>
            <a href="/" class="btn btn-success btn-lg">Khám phá sản phẩm</a>
        </div>
    </c:if>
                ...
                <div class="order-card">
                    ...
                    <div class="order-details">
                        ...
                        <div class="details-header">
                            ...
                            <span class="order-date text-uppercase">${paymentTypes[order.pmid]}</span>
                        </div>
                        <div class="details-header">
