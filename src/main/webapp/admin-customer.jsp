    ...
    <section class="left d-flex flex-column justify-content-between">
        <div class="top-left">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/admin-products"><i class="fa-solid fa-user"></i>Khách
                        hàng</a>
                </li>
                <li class="active">
                    <a href="${pageContext.request.contextPath}/admin-contributor"><i class="bi bi-coin"></i>Người phân
                        phối</a>
                </li>
                <hr>
                <li>
                    <a href="${pageContext.request.contextPath}/admin-aproved"><i class="fa-solid fa-bell"></i>Ảnh đang
                        chờ</a>
                </li>
                <li>
        ...
        <div class="mt-4">
            <div class="container header d-flex justify-content-between align-items-center mb-3 py-2">
                ...
                <div class="add-category">
                    <button class="btn btn-primary" id="openModalBtn">+ Thêm khách hàng mới</button>
                </div>
            </div>
            ...
            <table id="userTable" class="display table table-bordered table-striped">
                ...
                <c:forEach var="user" items="${users}">
                    <tr>
                        ...
                        <td>
                            <button class="btn edit-btn btn-warning" data-id="${user.uid}">Sửa</button>
                            <button class="btn delete-btn btn-danger" data-id="${user.uid}">Xóa</button>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
                ...
                <div class="modal-content">
                    <form id="categoryForm" action="${pageContext.request.contextPath}/admin-customer" method="POST">
                        <div class="modal-header">
                            <h5 class="modal-title" id="categoryModalLabel">Thêm người dùng</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="categoryProducts" name="password"
                                       required>
                            </div>
                        </div>
