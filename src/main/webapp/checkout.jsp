...
<div id="checkout">
    <div class="container-fluid">
        <div class="checkout-container">
            <h1 class="ml-3 mb-3">Thanh toán</h1>
                    ...
                    <div class="purchase-details-container">
                        <div class="purchase-details">
                            <div class="purchase-details-header d-flex mb-3">
                                ...
                                <span class="select-items">(3 sản phẩm)</span>
                                <a class="edit-cart txt-deco-none ml-auto" href="cart.html">Chỉnh sửa giỏ hàng</a>
                            </div>
                            <div class="purchase-details-body">
                                ...
                                <div class="payment-details mt-4">
                                    ...
                                    <div class="d-flex justify-content-between mt-2 pb-2"
                                        ...
                                        <span class="text-danger">-${discountAmount}</span>
                                    </div>
