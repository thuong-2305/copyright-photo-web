                        ...
                        <div class="content-license-agreement">
                            <ul class="style-none">
                                <li class="email-preference mb-3">
                                    ...
                                    <span>Có, tôi muốn nhận những thông tin mới nhất và những ưu đãi đặc biệt - tôi hiểu rằng có thể hủy thông báo bất kì lúc nào.</span>
                                </li>
                                <li id="accept-term">
                            ...
                            <div class="purchase-details-body">
                                ...
                                <div class="payment-details mt-4">
                                    ...
                                    <div class="d-flex justify-content-between mt-2">
                                        ...
                                        <span class="fw-bold total-amount"><fmt:formatNumber value="${totalAfterDiscount}" pattern="#,##0"/></span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container d-flex justify-content-space">
        <div class="footer-column">
            ...
            <div class="social-icons d-flex">
                <a href="#" class="text-decoration-none text-dark mx-2"><i class="fa-brands fa-facebook-f"></i></a>
                <a href="#" class="text-decoration-none text-dark mx-2"><i class="fa-brands fa-github"></i></a>
                <a href="#" class="text-decoration-none text-dark mx-2"><i class="fa-brands fa-pinterest-p"></i></a>
            </div>
        </div>
        <div class="footer-column">
            <h3>Giấy phép</h3>
        ...
        <div class="footer-column">
            ...
            <p>Đăng ký nhận bản tin của chúng tôi để nhận được những hình ảnh mới, mẹo và chương trình giảm giá mỗi tuần.</p>
